...
# Generate code
# for client-gen to work properly, the source must also be on the GOPATH, i.e., ln -s $GOPATH/github.com/dominodatalab/forge $PWD
generate:
	$(CLIENT_GEN)  --output-package="github.com/dominodatalab/forge/internal" --clientset-name="clientset" --input-base="github.com/dominodatalab/forge/api" --input="forge/v1alpha1" --go-header-file="./hack/boilerplate.go.txt"

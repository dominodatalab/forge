...
func createOrUpdateCRD(logger logr.Logger, crdClient apixv1client.CustomResourceDefinitionInterface) error {
...
func deleteCRD(logger logr.Logger, crdClient apixv1client.CustomResourceDefinitionInterface) error {
	crd, err := loadCRD(logger)
	if err != nil {
		return err
	}

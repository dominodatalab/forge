...
func TestCreateCRD(t *testing.T) {
	...
	if err := createOrUpdateCRD(logger, crdClient); err != nil {
		t.Error(err)
	}
...
func TestApplyCRDError(t *testing.T) {
	...
	if err := createOrUpdateCRD(logger, fakeClient.ApiextensionsV1().CustomResourceDefinitions()); err != expected {
...
func TestDeleteCRD(t *testing.T) {
	...
	if err := deleteCRD(logger, crdClient); err != nil {
		t.Error(err)
	}
...
func TestDeleteCRDError(t *testing.T) {
	...
	if err := deleteCRD(logger, crdClient); err != expected {

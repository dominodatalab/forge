...
import (
	...
	"github.com/dominodatalab/forge/internal/clientset/scheme"
	rest "k8s.io/client-go/rest"
)

type ForgeV1alpha1Interface interface {
	RESTClient() rest.Interface
	ContainerImageBuildsGetter
}
...
func (c *ForgeV1alpha1Client) ContainerImageBuilds(namespace string) ContainerImageBuildInterface {
	return newContainerImageBuilds(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ForgeV1alpha1Client, error) {
	...
	return &ForgeV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ForgeV1alpha1Client for the given config and

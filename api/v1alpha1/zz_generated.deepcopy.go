...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerImageBuildState) DeepCopyInto(out *ContainerImageBuildState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerImageBuildState.
func (in *ContainerImageBuildState) DeepCopy() *ContainerImageBuildState {
	if in == nil {
		return nil
	}
	out := new(ContainerImageBuildState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ContainerImageBuildStatus) DeepCopyInto(out *ContainerImageBuildStatus) {
	*out = *in
	if in.States != nil {
		...
		*out = make([]ContainerImageBuildState, len(*in))
		copy(*out, *in)
	}
	if in.ImageURLs != nil {
